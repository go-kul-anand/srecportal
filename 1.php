    ...
    <div>
        <div class="custom-dropdown">
            <div style="width: 300px;;">
                ...
                <select id="Department" onchange="adjustOptionWidth(this)">
                    ...
                    <option selected value="Department of Artificial Intelligence and Data Science">Department of
                        Artificial
        ...
        <div class="input-section" style="display: flex; justify-content: center; margin-left: 10px;">
            <div style="width: calc(34%);">
                ...
                <input type="text" id="NameoftheMentor" placeholder="Name of the Mentor" value="ram">
            </div>
            <div style="width: calc(34%);">
                <label for="Class">Class:</label>
                <input type="text" id="Class" placeholder="Class" value="test">
            </div>
        ...
        <div class="input-section" style="display: flex; justify-content: center; margin-left: -23px;">
            <div style="width: calc(34%);">
                ...
                <input type="text" id="designation" placeholder="Mentor Designation" value="desg">
            </div>
            <div style="width: calc(30%);">
